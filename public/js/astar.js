...
GraphSearch.prototype.cellClicked = function ($end) {
    ...
    if (path.length === 0) {
        $("#message").text("não foi possível encontrar um trajeto (" + duration + "ms)");
        this.animateNoPath();
    }
    else {
        $("#message").text("a procura demorou " + duration + "ms.");
        this.drawDebugInfo();
...
GraphSearch.prototype.cellClicked = function ($end) {
    ...
    if (path.length === 0) {
        ...
        $("#message").text("a pesquisa demorou " + duration + "ms.");
        this.drawDebugInfo();
        this.animatePath(path);
    }
};
